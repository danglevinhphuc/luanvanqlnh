...
@section('title')Danh mục món ăn & thức uống| {{$loaimon[0]->loaiMon}} |Nhà hàng FOOD
@endsection
@section('content')
<style type="text/css">
	.pagination {
...
<div class="wrap-fullwidth">
	...
	<div class="wrap-content">        
		...
		<h3 class="index-title">Tất cả món ăn & uống về  : {{$loaimon[0]->loaiMon}}</h3>
		<div class="clear"></div>
		...
		<center>
			<div class="toolbar">
					<div class="row text-center">{{$monan->links()}}</div>
				</div>
		</center>
		<!-- Pagination -->
		<!-- pagination -->
